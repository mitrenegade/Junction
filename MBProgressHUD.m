...
#define SETWIDTH 135.0f
#define SETHEIGHT 135.0f
...
- (void)layoutSubviews {
    ...
    if (nil != self.labelText) {
        ...
        //GEOFF OBERHOFER
        CGSize dims = [self.labelText sizeWithFont:self.labelFont
                                      constrainedToSize:CGSizeMake(SETWIDTH, [UIScreen mainScreen].bounds.size.height)
        ...
        if (nil != self.detailsLabelText) {
            ...
            //GEOFF OBERHOFER
            dims = [self.detailsLabelText sizeWithFont:self.detailsLabelFont constrainedToSize:CGSizeMake(SETWIDTH, [UIScreen mainScreen].bounds.size.height) lineBreakMode:UILineBreakModeWordWrap];
    ...
    //GEOFF OBERHOFER
    if (self.width < (SETWIDTH + 2 * margin)) {
        self.width = SETWIDTH + 2 * margin;
    }
    //GEOFF OBERHOFER
    if (self.height < SETHEIGHT +2 * margin) {
        self.height = SETHEIGHT + 2 * margin;
    }
}
